...
<?php
    ...
    $tv_2=mysqli_query($tv,"select max(sap_xep_trang_chu) from san_pham");
    ...
    if($ten!="")
    {
        if($ten_file_anh!="")
        {
            $tv_1=mysqli_query($tv,"select count(*) from san_pham where hinh_anh='$ten_file_anh' ");
            ...
            if($tv_k_2[0]==0)
            {
                ...
                $duong_dan_anh="../anh/san_pham/".$ten_file_anh;
