...
<form action="" method="post" enctype="multipart/form-data" >
    <table width="990px" >
        <tr>
            <td width="180px" ><b style="color:blue;font-size:20px" >Sửa banner</b><br><br> </td>
        ...
        <tr>
            ...
            <td>
                <br>
                <input type="submit" name="bieu_mau_sua_banner" value="Sửa" style="width:200px;height:50px;font-size:24px" >
            </td>
        </tr>
    </table>
</form>