...
<?php
    ...
    $tv_1=mysqli_query($tv,"select count(*) from hoa_don");
    $tv_2=mysqli_fetch_array($tv_1);
    $so_trang=ceil($tv_2[0]/$so_dong_tren_mot_trang);
   
    $vtbd=($_GET['trang']-1)*$so_dong_tren_mot_trang;
    $tv_1=mysqli_query($tv,"select * from hoa_don order by id desc limit $vtbd,$so_dong_tren_mot_trang");
?>
<table width="990px" class="tb_a1" >
    <tr style="background:#CCFFFF;height:40px;text-align:center;" >
        <th width="370px" ><b>Tên</b></th>
        <th width="300px" ><b>Email</b></th>
        <th width="120px" ><b>Điện thoại</b></th>
        <th align="center" width="100px" colspan="2"><b>Chức năng</b></th>
    </tr>
    <?php
