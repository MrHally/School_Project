...
<?php
    ...
    $tv_1=mysqli_query($tv,"select count(id) from phu_kien where trang_chu='co' ");
    $tv_2=mysqli_fetch_array($tv_1);
    $so_trang=ceil($tv_2[0]/$so_dong_tren_mot_trang);
   
    $vtbd=($_GET['trang']-1)*$so_dong_tren_mot_trang;

    $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh,sap_xep_trang_chu from phu_kien where trang_chu='co' order by sap_xep_trang_chu desc limit $vtbd,$so_dong_tren_mot_trang");
?>
    ...
    <table width="990px" class="tb_a1" >
        ...
        <tr>
            ...
            <td colspan="2" align="center" >
                <br>
                <input type="submit" name="bieu_mau_phu_kien_trang_chu" value="Cập nhật" style="width:180px;height:50px;font-size:24px" >
                <br><br>
            </td>           
        </tr>
        <tr>
            <td colspan="5" align="center" >
                ...
                <?php
                    ...
                    {
                        $link_phan_trang="?thamso=phu_kien_trang_chu&trang=".$i;
