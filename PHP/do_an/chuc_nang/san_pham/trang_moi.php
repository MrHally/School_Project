<br><br>
<img src='/anh/banner/banner5.jpg' alt='Sản phẩm mới' width="1200px">
<br><br>
<h3>Mới ra lò</h3>
<br>
<?php
...
<center>
    <?php
        $tv = mysqli_connect("localhost","root","","ban_hang");
        mysqli_query($tv,'SET NAMES "UTF8"');
        $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh,thuoc_menu from san_pham order by id desc limit $vtbd,$so_du_lieu");
        echo "<table>";
