<?php
    ...
    $so_du_lieu=9;
    $tv_1=mysqli_query($tv,"select count(*) from phu_kien where thuoc_menu='$id';");
    ...
    echo "<center>";
    $tv_3=mysqli_query($tv,"select ten from menu_doc_pk where id ='$id';");
    $tv_4=mysqli_fetch_array($tv_3);
    echo "<h3 class='mt-2 mb-3' style='text-align: left;'>".$tv_4['ten']."</h3>";
    echo "<br>";
    echo "<table>";
    $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh,thuoc_menu from phu_kien where thuoc_menu='$id' order by id desc limit $vtbd,$so_du_lieu");
    ...
    echo "<tr>";
        echo "<td colspan='3' align='center' >";
            echo "<div class='phan_trang' >";
                ...
                {
                    $link="?thamso=xuat_phu_kien&id=".$_GET['id']."&trang=".$i;
                    echo "<a href='$link' >";
                        echo $i;echo " ";
                    echo "</a>";
                }
