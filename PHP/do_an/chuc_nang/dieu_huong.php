<?php
    ...
    switch($tham_so)
    {
        ...
        break;
        case "xuat_san_pham":
            echo "<center><img style='width: 75%; margin-bottom: 10px;' src='../../anh/slideshow/a-4.jpg' alt='' srcset=''></center>";
            include("chuc_nang/menu_doc/menu_doc.php");
            include("chuc_nang/san_pham/xuat.php");
        break;
        case "xuat_phu_kien":
            echo "<center><img style='width: 75%; margin-bottom: 10px;' src='../../anh/slideshow/a-3.jpg' alt='' srcset=''></center>";
