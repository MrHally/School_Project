...
<?php
    ...
    if(isset($_POST['bieu_mau_them_phu_kien']))
    {
        include("chuc_nang/phu_kien/them_phu_kien_vao_csdl.php");
        trang_truoc_html();
    }
    if(isset($_POST['bieu_mau_sua_phu_kien']))
    {
        include("chuc_nang/phu_kien/sua_phu_kien_o_trong_csdl.php");
        trang_truoc_html();
    }
    if(isset($_GET['xoa_phu_kien']))
    {
        include("chuc_nang/phu_kien/xoa_phu_kien.php");
        trang_truoc_html();
    }
    ...
    if(isset($_POST['bieu_mau_them_banner']))
    {
        include("chuc_nang/banner/them_banner_vao_csdl.php");
        trang_truoc_html();
    }
    ...
    if(isset($_GET['xoa_banner']))
    {
        include("chuc_nang/banner/xoa_banner.php");
        trang_truoc_html();
    }
