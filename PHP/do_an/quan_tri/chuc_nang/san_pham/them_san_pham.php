...
<form action="" method="post" enctype="multipart/form-data" >
    <table width="990px" >
        <tr>
            <td colspan="2" ><b style="color:blue;font-size:20px" >Thêm món ăn</b><br><br> </td>
        ...
        <tr>
            ...
            <td>
                <br>
                <input type="submit" name="bieu_mau_them_san_pham" value="Thêm món ăn" style="width:200px;height:50px;font-size:24px" >
            </td>
        </tr>
    </table>
</form>