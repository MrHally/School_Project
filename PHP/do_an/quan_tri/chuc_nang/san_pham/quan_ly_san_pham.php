...
<div style="width:990px;text-align:left" >
    ...
    <option value="" >Toàn bộ món ăn</option>
    <?php
...
<?php
    ...
    {
        $tv_1=mysqli_query($tv,"select count(*) from san_pham where thuoc_menu='$id_menu' ");
    }
    ...
    if($id_menu=="toan_bo_san_pham")
    {
        $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh from san_pham order by id desc limit $vtbd,$so_dong_tren_mot_trang");
    }
    else
    {
        $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh from san_pham where thuoc_menu='$id_menu' order by id desc limit $vtbd,$so_dong_tren_mot_trang");
    }
