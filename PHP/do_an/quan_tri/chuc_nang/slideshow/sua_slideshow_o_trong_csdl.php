<?php
    ...
    if($ten_file_anh_tai_len!="")
    {
        $tv_1=mysqli_query($tv,"select count(*) from slideshow where hinh='$ten_file_anh' ");
    ...
    if($kiem_tra_anh=="hop_le")
    {
        ...
        if($ten_file_anh_tai_len!="")
        {               
            $duong_dan_anh="../anh/slideshow/".$ten_file_anh_tai_len;
            move_uploaded_file($_FILES['hinh_anh']['tmp_name'],$duong_dan_anh);
            $duong_dan_anh_cu="../anh/slideshow/".$_POST['ten_anh'];
