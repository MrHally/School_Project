...
<?php
    ...
    $link_dong="?thamso=quan_ly_phu_kien&id_menu=".$_GET['id_menu']."&trang=".$_GET['trang'];
?>
<form action="" method="post" enctype="multipart/form-data" >
    <table width="990px" >
        <tr>
            <td width="180px" ><b style="color:blue;font-size:20px" >Sửa đồ uống</b><br><br> </td>
        ...
        <tr>
            ...
            <td>
                <br>
                <input type="submit" name="bieu_mau_sua_phu_kien" value="Sửa sản phẩm" style="width:200px;height:50px;font-size:24px" >
            </td>
        </tr>
    </table>
</form>