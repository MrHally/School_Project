...
<?php
    ...
    $tv_1=mysqli_query($tv,"select id,ten,gia,hinh_anh from phu_kien where noi_bat='co' order by id desc limit 0,10");
?>
    ...
    <form method="post" >
        <table width="850px" class="tb_a1" >
            ...
            <tr>
                ...
                <td align="center" >
                    <br>
                    <input type="submit" name="bieu_mau_phu_kien_noi_bat" value="Cập nhật" style="width:120px;height:40px;font-size:20px" >
                    <br><br>
                </td>           
            </tr>
