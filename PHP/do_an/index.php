...
<body>
    <!-- sale banner -->
    <div class="banner-sale py-1">Mùa hè tới rồi hãy đặt đồ ăn ngay cho no bụng nè!!!</div>
    <header>
        <!-- navbar -->
        <?php
    ...
    <footer class="about-us">
        <div class="container mt-3">
            <table class="footer-table">
                <tr class="footer-col">
                    <th class="footer-row" width="9000px" colspan="2">Về căn tin A4</th>
                ...
                <tr class="footer-col">
                    <td class="footer-row" rowspan="3">
                        Nơi đây bán đồ ăn với nước uống ngon.
                    </td>
        ...
        <hr style="margin: 0px">
        <div class="footer-cpy">Copyright © 2023 Căn tin A4.</div>
    </footer>
    </div>
